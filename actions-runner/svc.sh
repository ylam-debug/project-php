...
SVC_NAME="actions.runner.ylam-debug-project-php.MacBook-Pro-de-Youssoupha"
SVC_NAME=${SVC_NAME// /_}
SVC_DESCRIPTION="GitHub Actions Runner (ylam-debug-project-php.MacBook-Pro-de-Youssoupha)"
